...
\input{Chapters/generating_functions}
...
\input{Chapters/kalman}
\input{Chapters/me}
\input{Chapters/em}
\input{Chapters/hidden}
\input{Chapters/potts}
\input{Chapters/unfolding}
%\ctparttext{We throughly discuss the theory behind the most}
\part{Appendix}
\appendix
%\input{Chapters/AppendixA}
%\input{Chapters/numerical_sde}
